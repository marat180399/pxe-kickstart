...
9) On LOCALHOST create another guest VM with following command: virt-install --name redos-arm --memory 4096 --vcpus 2 --disk size=30 --network network=internal --pxe --os-variant rhel7.7
